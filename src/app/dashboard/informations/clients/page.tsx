...
// ---------------------------------------------------------------------------
// Informations » Clients (Phase H3) — reprise de la page Clients itération 1
// (l'ancienne route /dashboard/clients reste accessible jusqu'au redirect H9).
// ---------------------------------------------------------------------------

export default async function InformationsClientsPage() {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Créez le dossier d’un client (propriétaire + 1er animal). Cliquez sur un nom pour
          ouvrir la fiche.
        </p>
      </div>
