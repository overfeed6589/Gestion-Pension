...
// ---------------------------------------------------------------------------
// Informations » Factures (Phase H3) — reprise de la page Factures itération 1
// (l'ancienne route /dashboard/invoices reste accessible jusqu'au redirect H9).
// ---------------------------------------------------------------------------
...
export default async function InformationsFacturesPage() {
              ...
              {invoices.map((inv) => (
                <tr key={inv.id}>
                  ...
                  <td className="px-3 py-2">
                    {inv.client ? (
                      <FicheLink kind="client" id={inv.client.id}>
