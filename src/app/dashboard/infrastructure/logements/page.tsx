...
// ---------------------------------------------------------------------------
// Infrastructure » Logements & box (Phase H5) — reprise de la page Housing
// itération 1 (l'ancienne route /dashboard/housing reste accessible jusqu'au
// redirect H9 ; les mutations restent réservées au rôle `owner`).
// ---------------------------------------------------------------------------
